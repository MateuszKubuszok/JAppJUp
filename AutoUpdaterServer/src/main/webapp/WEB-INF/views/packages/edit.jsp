...
<head>
	...
	<title><spring:message code="repository.name" /> - <spring:message code="model.package.edit" arguments="${_package.program.name}" /></title>
...
<body>
	...
	<h1><spring:message code="model.package.edit" arguments="${_package.program.name}" /></h1>
