...
public class EnvironmentDefaultConfiguration {
     ...
     * Defines default
     */
    public static final String DEFAULT_TEMPORARY_DIRECTORY = System.getProperty("java.io.tmpdir")
            + DEFAULT_CLIENT_NAME;

    /**
     * Defines default localization of local app data for client.
     */
    public static final String DEFAULT_LOCAL_APPLICATION_DATA = os.getLocalAppData()
            + File.separator + DEFAULT_CLIENT_NAME;
    ...
    public static final String DEFAULT_INSTALLATION_DATA_XML_PATH = DEFAULT_LOCAL_APPLICATION_DATA
            + File.separator + "installationData.xml";
    ...
    public static final String DEFAULT_CLIENT_EXECUTABLE_PATH = "java -jar "
            + DEFAULT_CLIENT_DIRECTORY_PATH + File.separator + "Client.jar";

    /**
     * Defines default path to Installer.jar.
     */
    public static final String DEFAULT_INSTALLER_PATH = DEFAULT_CLIENT_DIRECTORY_PATH
