...
public class TestCopyCommandGenerator {
    @Test
    public void testGenerateCommand() throws InvalidCommandException {
        ...
        // when
        String[] command = new CopyCommandGenerator().generateCommand(update, pathToInstaller,
                programSettings);
        ...
        assertThat(command).as("Should generate correct command").isEqualTo(
                new String[] {
                        ...
                        "-jar",
                        "./Installer.jar",
                        update.getUniqueIdentifer(),
                        COPY.toString(),
                        file.getAbsolutePath(),
                        programSettings.getPathToProgramDirectory() + separator
